 ...
 * Generated at: 2021-06-29 08:29:17 UTC
...
public final class joinForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("		\r\n");
      out.write("		/* 왜 실행 안되는지 알고 싶음!!! */\r\n");
      out.write("		if(id == \"\"){\r\n");
      out.write("			$('#idCheckMsg').text('ID를 입력하세요')\r\n");
      out.write("			return false\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      out.write("		/* 왜 실행 안되는지 알고 싶음!!! */\r\n");
      out.write("		if($('#tel2').length > 4 || $('#tel3').length > 4){\r\n");
      out.write("			$('#telCheckMsg').text('4글자 이내로 입력해주세요')\r\n");
      out.write("			return false\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      out.write("		\r\n");
      ...
      out.write("		\r\n");
      out.write("		if(f.passwordCheck.value != f.password.value){\r\n");
      out.write("			console.log('불일치')\r\n");
      out.write("			$('#pwCheckMsg').text('비밀번호가 일치하지 않습니다.')\r\n");
      out.write("			return false\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      ...
      out.write("		\r\n");
      out.write("	/* id 중복체크 */\r\n");
      out.write("	function idDoubleCheck(e) {\r\n");
      out.write("		let id = $('#id').val()\r\n");
      out.write("		\r\n");
      out.write("		if(id != \"\"){\r\n");
      out.write("			let options = 'top=10, left=10, width=400, height=200, resizable=no';\r\n");
      out.write("			let url = 'doubleCheck.jsp?id='+id\r\n");
      out.write("			\r\n");
      out.write("			window.open(url, '중복체크' , options)\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      out.write("	}\r\n");
      out.write("	\r\n");
      ...
      out.write("		<hr>\r\n");
      out.write("		\r\n");
      out.write("		<form action=\"join.jsp\" method=\"post\" name=\"inputForm\" onsubmit=\"return checkForm()\">\r\n");
      out.write("			<table border=\"1\" style=\"width: 80%\">\r\n");
      out.write("				<tr>\r\n");
      out.write("					<th>아이디</th>\r\n");
      out.write("					<td>\r\n");
      out.write("						<input type=\"text\" name=\"id\" id =\"id\" required>\r\n");
      out.write("						<button onclick=\"idDoubleCheck(this)\">중복체크</button>\r\n");
      out.write("						<span id=\"idCheckMsg\" style=\"color:red;font-weight:bold\"></span>\r\n");
      out.write("					</td>\r\n");
      out.write("				</tr>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<th>이름</th>\r\n");
      ...
      out.write("						<span id=\"nameCheckMsg\" style=\"color:red;font-weight:bold\"></span>\r\n");
      out.write("					</td>\r\n");
      out.write("				</tr>\r\n");
      out.write("				<tr>\r\n");
      ...
      out.write("					<td>\r\n");
      out.write("						<input type=\"password\" name=\"passwordCheck\" id = \"passwordCheck\" required>\r\n");
      out.write("						<span id=\"pwCheckMsg\" style=\"color:red;font-weight:bold\"></span>\r\n");
      out.write("					</td>\r\n");
      out.write("				</tr>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<th>이메일</th>\r\n");
      ...
      out.write("						@\r\n");
      out.write("						<select name=\"email_domain\">\r\n");
      ...
      out.write("						style=\"width: 20%\"\r\n");
      out.write("						> \r\n");
      out.write("						<span id=\"telCheckMsg\" style=\"color:red;font-weight:bold\"></span>\r\n");
      out.write("					</td>\r\n");
      out.write("				</tr>\r\n");
      out.write("				<tr>\r\n");
      ...
      out.write("					<th>주소</th>\r\n");
      out.write("					<td>\r\n");
      out.write("						<input type=\"text\" name=\"basic_addr\" required id=\"sample6_address\" placeholder=\"주소\"><br>\r\n");
      out.write("						<input type=\"text\" name=\"detail_addr\" required id=\"sample6_detailAddress\" placeholder=\"상세주소\">\r\n");
